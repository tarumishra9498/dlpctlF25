...
cv.createTrackbar("thresh_val", "Hough Circle Image", 79, 255, nothing)
cv.createTrackbar("max_val", "Hough Circle Image",0, 255, nothing)
cv.createTrackbar("med_blur", "Hough Circle Image", 11, 100, nothing)
cv.createTrackbar("param1","Hough Circle Image",91, 300, nothing)
cv.createTrackbar("param2","Hough Circle Image",26, 100, nothing)
cv.createTrackbar("min_r","Hough Circle Image",5, 50, nothing)
...
while True:
    ...
    if not np.array_equal(frame[h//2, w//2], [0,0,0]):
        ...
        ret, gray = cv.threshold(gray, thresh_val, max_val, cv.THRESH_TOZERO)
